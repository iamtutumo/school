<style type="text/css">
    ...
    .single-facilities::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/round-lime-green.png);
    }
    ...
    .single-news::before {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-1-lime-green.png);
    }
    ...
    .single-notice::after,
    .single-news::after {
        background-image: url(<?php echo IMG_URL; ?>front/icon/border-2-lime-green.png);
    }
    ...
    .welcome-banner::after {
        background-color: #74e974;
    }

    .single-hero-carousel .box {
        background: rgb(90 233 55 / 50%); 
    }
